#ifndef COMPUTE_SHADER_SRC_APP_APPLICATIONWINDOW_HPP_
#define COMPUTE_SHADER_SRC_APP_APPLICATIONWINDOW_HPP_
...
#endif /* COMPUTE_SHADER_SRC_APP_APPLICATIONWINDOW_HPP_ */
